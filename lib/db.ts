...
function initTables(db: Database.Database) {
  ...
  if (infoCount.count === 0) {
    const cards = [
      { title: 'Incense Sticks', subtitle: 'Handcrafted Traditions', description: 'Discover the art of traditional incense making with premium natural ingredients.', image: 'https://res.cloudinary.com/dbvmfmob4/image/upload/v1779477016/delight_products/mw9mdhwkm2xmtlwlhme9.jpg', slug: 'incense-sticks', detail_content: '<h2>The Art of Incense Making</h2><p>Our incense sticks are handcrafted using a blend of natural resins, essential oils, and aromatic herbs. Each stick is carefully rolled by skilled artisans following traditional methods passed down through generations.</p><h2>What We Use</h2><p>We source only the finest sandalwood powder, natural bamboo sticks, essential oils, and plant-based binding agents. No synthetic fragrances or chemicals are ever used.</p><h2>How We Make Them</h2><p>The process begins with selecting premium raw materials, followed by hand-blending the aromatic paste, rolling each stick individually, and slow-drying in natural air for optimal fragrance retention.</p>' },
      { title: 'Air Fresheners', subtitle: 'Breathe Pure Luxury', description: 'Premium air care solutions that transform your space with lasting freshness.', image: 'https://res.cloudinary.com/dbvmfmob4/image/upload/v1779477019/delight_products/mihfvg9i4bohcajarnf0.jpg', slug: 'air-fresheners', detail_content: '<h2>Science Meets Nature</h2><p>Our air fresheners combine cutting-edge fragrance technology with natural essential oils to create long-lasting, room-filling scents that truly transform your space.</p><h2>Premium Ingredients</h2><p>Each product features a proprietary blend of essential oils, naturally-derived fragrance compounds, and eco-friendly propellants designed for maximum freshness with minimal environmental impact.</p>' },
      { title: 'Safety Wax Matches', subtitle: 'Strike with Confidence', description: 'Premium safety matches crafted for reliable performance and superior quality.', image: 'https://res.cloudinary.com/dbvmfmob4/image/upload/v1779476158/delight_products/vhimexta6wepflrccbct.jpg', slug: 'safety-wax-matches', detail_content: '<h2>Superior Match Quality</h2><p>Our safety wax matches are manufactured using the highest quality materials. Each match head is formulated for reliable ignition and a steady, clean flame.</p><h2>Safety First</h2><p>Designed with a special safety coating that prevents accidental ignition, our matches meet international safety standards while delivering reliable performance every time.</p>' },
      { title: 'Candles', subtitle: 'Illuminate Your Moments', description: 'Hand-poured candles made with premium wax for a clean, even burn.', image: 'https://res.cloudinary.com/dbvmfmob4/image/upload/v1779476169/delight_products/dbj06zeb71pumlowtwbs.jpg', slug: 'candles', detail_content: '<h2>The Perfect Glow</h2><p>Our candles are hand-poured using premium grade wax that burns cleanly and evenly. Each candle is crafted to provide hours of warm, ambient light.</p><h2>Quality Wax</h2><p>We use a specially formulated wax blend that produces minimal soot and provides a consistent, beautiful flame throughout the life of the candle.</p>' },
    ];
