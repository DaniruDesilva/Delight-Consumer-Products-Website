              ...
              <div className={styles.cardBody}>
                <div className={styles.formGrid}>
                  <div className={`${styles.formGroup} ${styles.full}`}>
                    ...
                    <input name="name" value={form.name} onChange={handleChange} placeholder="e.g. Lavender Incense Sticks" required />
                  </div>
                  <div className={`${styles.formGroup} ${styles.full}`}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input name="original_price" type="number" step="0.01" value={form.original_price} onChange={handleChange} placeholder="For discount display" />
                  </div>
                  <div className={styles.formGroup}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input name="min_order_quantity" type="number" value={form.min_order_quantity} onChange={handleChange} min="1" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.cardBody}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                  ...
                  <button type="button" className={`${styles.toggle} ${form.is_featured ? styles.active : ''}`} onClick={() => setForm({ ...form, is_featured: !form.is_featured })} />
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
